  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-3 space-y-6 p-14">
        ...
        <a href={Resume} download className="text-nowrap rounded-lg border border-indigo-600 bg-black px-5 py-4 text-lg font-bold text-white shadow-lg shadow-indigo-700 transition-all duration-300 hover:translate-y-2 hover:shadow-xl">Resume</a>
